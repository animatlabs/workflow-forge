...
public class Program
{
    public static int Main()
    {
        ...
        try
        {
            ...
            {
                Console.WriteLine("  ERROR: No Costura resources found - Costura not working");
                return 1;
            }
            ...
            {
                Console.WriteLine($"  WARN: FluentValidation.dll exists in output (for development)");
            ...
            {
                Console.WriteLine("  ERROR: WorkflowForge.dll is embedded - this will cause conflicts");
                return 1;
            }
            else
            {
            ...
            Console.WriteLine("Users can have any version of FluentValidation and it will not conflict with the version embedded in this extension.");
